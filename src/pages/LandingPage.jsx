        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex-shrink-0 flex items-center">
              <span className="text-blue-600 font-bold text-xl">Attendance</span>
            </div>
            ...
            <div className="flex items-center">
              <button onClick={(e) => navigate("/signup")} className="ml-4 px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700">
                Sign up
              </button>
              <button onClick={(e) => navigate("/login")} className="ml-4 px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-blue-600 bg-white hover:bg-gray-50 hover:border-blue-600">
                Log in
              </button>
            </div>
          </div>
          ...
          <div className="lg:grid lg:grid-cols-12 lg:gap-8">
            ...
            <div className="mt-16 sm:mt-24 lg:mt-0 lg:col-span-6">
              <div className="bg-white sm:max-w-md sm:w-full sm:mx-auto sm:rounded-lg sm:overflow-hidden lg:mx-0 shadow-xl">
                <img src="src/assets/dashboard.png" alt="Dashboard preview" className="w-full object-cover" />
              </div>
            </div>
          </div>
        </div>
